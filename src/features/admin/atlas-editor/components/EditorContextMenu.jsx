...
import { MapPin, Footprints, Hexagon, Type, X, Edit2, Copy, Trash2 } from 'lucide-react';
...
// 3. MAIN CONTAINER
// ==========================================
// Hoisted to module scope: a component declared inside a render body is a new type
// on every render, so React remounts it. MenuItem closes over nothing, so this is
// a straight move.
