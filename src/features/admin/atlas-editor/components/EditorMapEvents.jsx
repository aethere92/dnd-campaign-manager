...
export default function EditorMapEvents() {
	...
	// useCallback so the effect below can depend on it. `actions` is memoised by
	// AtlasEditorProvider and `map` is stable for the map's lifetime, so this
	// identity only changes when it genuinely needs to.
	...
	}, [selection, updateVisualViewport]);
