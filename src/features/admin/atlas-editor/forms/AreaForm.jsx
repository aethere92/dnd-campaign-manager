...
export default function AreaForm({ data, onChange, onDelete, onClose }) {
	// useState must run before any early return, or the hook order changes between
	// renders when `data` goes from set to null (deselecting an area) and React throws.
