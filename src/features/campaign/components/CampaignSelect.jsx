...
export default function CampaignSelect() {
	...
	return (
		// FIX: Use h-full + overflow-y-auto to create a local scroll container
		// distinct from the global body overflow:hidden
		<div
			className='h-full w-full overflow-y-auto custom-scrollbar font-sans'
			style={{
				backgroundImage: 'var(--bg-texture)',
				backgroundRepeat: 'repeat',
				// Ensures texture covers entire scrollable area
