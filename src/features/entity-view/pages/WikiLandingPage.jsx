...
import { useEntityFetching } from '../../wiki-layout/hooks/useEntityFetching';
import { useEntityGrouping } from '../../wiki-layout/hooks/useEntityGrouping';
import { getEntityConfig } from '../../../config/entity';
import { getSwimlanes, getStrategyMode } from '../config/viewStrategies'; // Import Logic
import { Swimlane } from '../components/landing/Swimlane'; // Import UI
...
export default function WikiLandingPage() {
	...
	return (
		<div className='p-6 md:p-12 max-w-[1600px] mx-auto min-h-full'>
			{/* Header */}
			...
			<div className='pb-20'>
				...
				{totalCount === 0 && (
					<div className='text-center py-32 opacity-40 flex flex-col items-center gap-4 border-2 border-dashed border-border rounded-xl'>
