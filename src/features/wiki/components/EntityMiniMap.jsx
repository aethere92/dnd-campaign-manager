		...
		<div
			...
			<div
				...
				<div
					...
					style={{
						// Position logic:
						// When fullscreen, add margin for mobile status bars (notch)
						// When inline, stick to standard corner
						top: activeFullscreen ? 'max(1rem, env(safe-area-inset-top))' : '1rem',
						right: activeFullscreen ? 'max(1rem, env(safe-area-inset-right))' : '1rem',
					}}>
					<button
